  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved volunteer as @volunteer" do
        ...
        post :create, {:volunteer => { "first_name" => "invalid value" }}, valid_session
        assigns(:volunteer).should be_a_new(Volunteer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested volunteer" do
        ...
        Volunteer.any_instance.should_receive(:update).with({ "first_name" => "MyString" })
        put :update, {:id => volunteer.to_param, :volunteer => { "first_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the volunteer as @volunteer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Volunteer.any_instance.stub(:save).and_return(false)
        put :update, {:id => volunteer.to_param, :volunteer => { "first_name" => "invalid value" }}, valid_session
        assigns(:volunteer).should eq(volunteer)
      end
